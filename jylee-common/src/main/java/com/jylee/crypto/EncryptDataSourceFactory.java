...
public class EncryptDataSourceFactory implements ObjectFactory {
   ...
   public static DataSource createDataSource(Properties properties)
      ...
      if (value != null) {
         dataSource.setUrl(value); // 암호화된 데이터를 복호화 시켜주는 함수
      }
    ...
    * @여기서는 kt의 암복화화 모듈을 사용해서 복호화했다.
    * @return String 복호화 된 Config 값
    */
 private static String encryptDBCPProperty(String orgStr) {
    String encrypt="";
     try {
         encrypt = CipherDesUtil.desEncrypt(orgStr);
     } catch (Exception e) {
   ...
   private static String decryptDBCPProperty(String encryptStr) {
      String result="";
       try {
           result = CipherDesUtil.desDecrypt(encryptStr);
       } catch (Exception e) {
           // TODO Auto-generated catch block
           e.printStackTrace();
       }
   ...
   public static void main(String args[]) {
       ...
       String encryptStr = encryptDBCPProperty("f1");
       
       System.out.println("encryptStr :" +encryptStr);
       
       // String password = "ysjLXvX1s+chQlbXK7SO0Q==";
       System.out.println("password :" +decryptDBCPProperty(encryptStr));
   }
