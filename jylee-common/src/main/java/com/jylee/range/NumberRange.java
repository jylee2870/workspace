...
public final class NumberRange extends Range implements Serializable {
     ...
     */
    public NumberRange(boolean hasMin, boolean hasMax, Number num1, Number num2) {
        this.hasMin = hasMin;
        this.hasMax = hasMax;
    ...
    public static void main(String args[]) {
        try {
            NumberRange nr1 = new NumberRange(100,100);
            System.out.println(" NumberRange(100,100) contains 100 : "+nr1.containsNumber(100));
            System.out.println(" NumberRange(100,100) contains 105 : "+nr1.containsNumber(105));
            System.out.println("");
            NumberRange nr2 = new NumberRange(100,200);
            System.out.println(" NumberRange(100,200) contains 90 : "+nr2.containsNumber(90));
            System.out.println(" NumberRange(100,200) contains 100 : "+nr2.containsNumber(100));
            System.out.println(" NumberRange(100,200) contains 150 : "+nr2.containsNumber(150));
            System.out.println(" NumberRange(100,200) contains 200 : "+nr2.containsNumber(200));
            System.out.println(" NumberRange(100,200) contains 250 : "+nr2.containsNumber(250));
            System.out.println("");
            NumberRange nr3 = new NumberRange(true, false, 100,200);
            System.out.println(" NumberRange(true, false, 100, 200) contains 90 : "+nr3.containsNumber(90));
            System.out.println(" NumberRange(true, false, 100, 200) contains 100 : "+nr3.containsNumber(100));
            System.out.println(" NumberRange(true, false, 100, 200) contains 150 : "+nr3.containsNumber(150));
            System.out.println(" NumberRange(true, false, 100, 200) contains 200 : "+nr3.containsNumber(200));
            System.out.println(" NumberRange(true, false, 100, 200) contains 250 : "+nr3.containsNumber(250));
            System.out.println("");
            NumberRange nr4 = new NumberRange(false, true, 100,200);
            System.out.println(" NumberRange(false, true, 100, 200) contains 90 : "+nr4.containsNumber(90));
            System.out.println(" NumberRange(false, true, 100, 200) contains 100 : "+nr4.containsNumber(100));
            System.out.println(" NumberRange(false, true, 100, 200) contains 150 : "+nr4.containsNumber(150));
            System.out.println(" NumberRange(false, true, 100, 200) contains 200 : "+nr4.containsNumber(200));
            System.out.println(" NumberRange(false, true, 100, 200) contains 250 : "+nr4.containsNumber(250));
            System.out.println("");
            NumberRange nr5 = new NumberRange(false, false, 100,200);
            System.out.println(" NumberRange(false, false, 100, 200) contains 90 : "+nr5.containsNumber(90));
            System.out.println(" NumberRange(false, false, 100, 200) contains 100 : "+nr5.containsNumber(100));
            System.out.println(" NumberRange(false, false, 100, 200) contains 150 : "+nr5.containsNumber(150));
            System.out.println(" NumberRange(false, false, 100, 200) contains 200 : "+nr5.containsNumber(200));
            System.out.println(" NumberRange(false, false, 100, 200) contains 250 : "+nr5.containsNumber(250));
        } catch(Exception e) {
